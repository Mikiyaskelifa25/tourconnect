  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 p-6 sm:p-10">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-slate-900 p-6 text-white shadow-lg mb-4">
        ...
        <div className="absolute bottom-0 left-0 w-24 h-24 bg-[#009739]/10 rounded-full translate-y-1/2 -translate-x-1/2 blur-2xl pointer-events-none" />
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest border-b border-slate-100 pb-2 flex items-center gap-2">
            <User className="w-4 h-4 text-[#009739]" />
            Basic Information
          </h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="grid gap-2">
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-[#009739] transition-colors" />
                <Input
                  id="name"
                  value={formData.name}
        ...
        <div className="space-y-4">
          <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest border-b border-slate-100 pb-2 flex items-center gap-2">
            <ShieldCheck className="w-4 h-4 text-[#009739]" />
          ...
          <div className="grid gap-2">
            ...
            <div className="relative group">
              <ShieldCheck className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-[#009739] transition-colors" />
              <Input
                id="license"
        ...
        <div className="space-y-4">
          <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest border-b border-slate-100 pb-2 flex items-center gap-2">
            <Languages className="w-4 h-4 text-[#009739]" />
            Languages Spoken
          </h4>
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2 mb-1 min-h-[3rem] items-center p-3 bg-slate-50/50 rounded-2xl border border-dashed border-slate-200">
              ...
              {formData.languages.map(l => (
                <Badge key={l.code} variant="secondary" className="pl-3 pr-1.5 py-1.5 gap-2 rounded-xl bg-white border-slate-100 shadow-sm text-slate-700 normal-case">
                  <div className="flex items-center gap-1.5">
                    <span className="uppercase font-black text-[#009739] text-[10px]">{l.code}</span>
                    <div className="w-1 h-1 rounded-full bg-slate-300" />
                    <span className="text-[10px] font-bold text-slate-500 uppercase">{l.proficiency}</span>
                  </div>
                  <button type="button" onClick={() => removeLanguage(l.code)} className="p-1 hover:bg-rose-50 hover:text-rose-500 rounded-lg transition-colors">
                    <X className="w-3 h-3" />
                  </button>
                </Badge>
              ))}
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="h-12 bg-slate-50 border-slate-100 rounded-xl w-16 sm:w-24 uppercase text-center font-bold text-slate-900 focus:bg-white transition-all"
                maxLength={2}
              />
              <select
                value={newLang.proficiency}
                onChange={e => setNewLang({ ...newLang, proficiency: e.target.value })}
                className="h-12 bg-slate-50 border border-slate-100 rounded-xl px-4 text-xs sm:text-sm font-bold text-slate-600 outline-none focus:bg-white focus:ring-4 ring-[#009739]/10 focus:border-[#009739]/30 appearance-none flex-1 min-w-0"
              >
              ...
              <Button type="button" variant="outline" onClick={addLanguage} className="h-12 w-12 shrink-0 rounded-xl border-slate-100 bg-slate-50 hover:bg-[#009739] hover:text-white hover:border-[#009739] transition-all p-0">
        ...
        <div className="space-y-4">
          <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest border-b border-slate-100 pb-2 flex items-center gap-2">
            <MapPin className="w-4 h-4 text-[#009739]" />
            Operating Regions
          </h4>
          <div className="space-y-3">
            <Label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">
            ...
            <div className="flex flex-wrap gap-2 mb-1 min-h-[3rem] items-center p-3 bg-slate-50/50 rounded-2xl border border-dashed border-slate-200">
              ...
              {formData.locations.map(loc => (
                <Badge key={loc} variant="default" className="pl-3 pr-1.5 py-1.5 gap-2 rounded-xl bg-white border border-slate-100 shadow-sm text-slate-700 normal-case">
                  <span className="font-bold text-slate-700">{loc}</span>
                  <button type="button" onClick={() => removeLocation(loc)} className="p-1 hover:bg-rose-50 hover:text-rose-500 rounded-lg transition-colors">
                    <X className="w-3 h-3" />
                  </button>
                </Badge>
              ))}
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                ...
                <Input
                  placeholder="Add location (e.g. Lalibela, Gondar)"
                  value={newLoc}
              ...
              <Button type="button" variant="outline" onClick={addLocation} className="h-12 w-12 shrink-0 rounded-xl border-slate-100 bg-slate-50 hover:bg-[#009739] hover:text-white hover:border-[#009739] transition-all p-0">
                <Plus className="w-5 h-5" />
              </Button>
            </div>
          </div>

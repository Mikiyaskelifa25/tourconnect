      ...
      <div className="p-4 sm:p-5 md:p-6">
        {dateRange?.from && dateRange?.to && (
          <div className={`mb-4 sm:mb-5 p-3 sm:p-4 rounded-lg border transition-colors ${
            ...
            {!availabilityResult.checking && availabilityResult.allAvailable && (
              <div className="mt-2 flex items-center gap-1.5 text-[11px] sm:text-xs text-blue-600">
          ...
          <div className="flex justify-center">
            <Calendar
              ...
              classNames={{
                ...
                selected: 'bg-blue-600 text-white hover:bg-blue-700 focus:bg-blue-600 rounded-full',
                range_start: 'rounded-full',
                range_end: 'rounded-full',
                range_middle: 'bg-blue-100 text-blue-900 hover:bg-blue-200 rounded-none',
                today: 'ring-2 ring-blue-400 ring-offset-1 font-bold text-blue-700 rounded-full',
